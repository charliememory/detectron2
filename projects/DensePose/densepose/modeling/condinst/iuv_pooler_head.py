...
def build_iuv_pooler_head(cfg, input_shape):
    # return GlobalIUVHead(cfg)
    return CoordGlobalIUVPoolerHead(cfg, use_rel_coords=True, input_shape=input_shape)


class CoordGlobalIUVPoolerHead(CoordGlobalIUVHead):
    ...
    def forward(self, fpn_features, s_logits, iuv_feats, iuv_feat_stride, rel_coord, instances, fg_mask=None, gt_instances=None):
        ...
        iuv_logit = self.densepose_pooler([iuv_logit], proposal_boxes)
