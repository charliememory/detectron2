...
__all__ = [
    ...
    "ResNet",
    "make_stage",
    "build_densepose_resnet_backbone",
]
...
class ResNet(Backbone):
    ...
    def __init__(self, stem, stages, num_classes=None, out_features=None, checkpoint_grad_num=0):
        """
        Args:
...
def build_densepose_resnetws_backbone(cfg, input_shape):
    """
    ...
    if cfg.SOLVER.AMP.ENABLED:
        ...
        return ResNet(stem, stages, out_features=out_features, 
                checkpoint_grad_num=0).freeze(freeze_at)
    else:
        return ResNet(stem, stages, out_features=out_features, 
                checkpoint_grad_num=cfg.MODEL.CONDINST.CHECKPOINT_GRAD_NUM).freeze(freeze_at)
