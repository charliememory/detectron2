...
class SimpleTrainer(TrainerBase):
    ...
    def __init__(self, cfg, model, data_loader, optimizer):
        ...
        self.accumulate_grad_iter = cfg.SOLVER.ACCUMULATE_GRAD_ITER
    ...
    def run_step(self):
        ...
        # losses = sum(loss_dict.values())/self.accumulate_grad_iter

        # """
        # If you need to accumulate gradients or do something similar, you can
        # wrap the optimizer with your custom `zero_grad()` method.
        # """
        # if self.iter%self.accumulate_grad_iter==0:
        ...
        self.optimizer.zero_grad()
        #
        for _ in range(self.accumulate_grad_iter):
            start = time.perf_counter()
            data = next(self._data_loader_iter)
            data_time = time.perf_counter() - start
            loss_dict = self.model(data)
